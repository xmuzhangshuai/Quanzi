...
public class JsonPostComment {
	...
	public JsonPostComment() {
		super();
	}

	public JsonPostComment(int c_id, int n_id, int c_userid, String c_small_avatar, String c_nickname, String c_gender,
			String c_content, String c_read, Date c_time) {
		super();
		this.c_id = c_id;
		this.n_id = n_id;
		this.c_userid = c_userid;
