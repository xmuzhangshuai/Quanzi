...
public class ActivityTable {
	...
	public static String A_ACT_TITLE = "a_act_title";
	public static String A_TARGET = "a_target";
	public static String A_THUMBNAIL = "a_thumbnail";
	public static String A_BIG_PHOTO = "a_big_photo";
