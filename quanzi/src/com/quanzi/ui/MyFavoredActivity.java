	...
	class PostAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (!TextUtils.isEmpty(jsonPostItem.getP_thumbnail())) {
				...
				imageLoader.displayImage(jsonPostItem.getP_big_photo(), holder.contentImageView,
			...
			holder.favorCountTextView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startActivity(new Intent(MyFavoredActivity.this, AllFavorsActivity.class).putExtra(
