 ...
 *
 * 项目名称：quanzi  
 * 类名称：MyFavoredActivity  
 * 类描述：我赞过的帖子
 * @author zhangshuai
 * @date 创建时间：2015-4-30 下午2:30:49 
 *
 */
public class MyFavoredActivity extends BaseFragmentActivity implements OnClickListener {
	...
	protected void findViewById() {
		// TODO Auto-generated method stub
		postListView = (PullToRefreshListView) findViewById(R.id.post_list);
...
//				postListView.setRefreshing();
			...
			public void onSuccess(int statusCode, Header[] headers, String response) {
				...
				if (statusCode == 200) {
					...
					if (temp != null) {
						LogTool.i("获取我赞过的帖子列表长度" + temp.size());
						//如果是首次获取数据
						if (page == 0) {
...
//							refresh();
						...
						//如果是获取更多
							...
							if (temp.size() < Config.PAGE_NUM) {
								pageNow = -1;
								ToastTool.showShort(MyFavoredActivity.this, "没有更多了！");
							}
							jsonPostItemList.addAll(temp);
						}
			...
			public void onFailure(int statusCode, Header[] headers, String errorResponse, Throwable e) {
				// TODO Auto-generated method stub
				LogTool.e("获取我赞过的帖子列表失败" + errorResponse);
			}
...
//				postListView.onRefreshComplete();
		...
		AsyncHttpClientTool.post(MyFavoredActivity.this, "post/getMyLike", params, responseHandler);
	}
	...
	class PostAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				view = LayoutInflater.from(MyFavoredActivity.this).inflate(R.layout.post_list_item, null);
			...
			view.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startActivity(new Intent(MyFavoredActivity.this, PostDetailActivity.class).putExtra(
							PostDetailActivity.POST_ITEM, jsonPostItem));
					MyFavoredActivity.this.overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
				}
			});
			...
			if (!TextUtils.isEmpty(jsonPostItem.getP_small_avatar())) {
				...
				if (userPreference.getU_id() != jsonPostItem.getP_userid()) {
					...
					holder.headImageView.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							Intent intent = new Intent(MyFavoredActivity.this, PersonDetailActivity.class);
							...
							MyFavoredActivity.this.overridePendingTransition(R.anim.zoomin2, R.anim.zoomout);
						}
					});
				}
			}
			...
			holder.favorCountTextView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (jsonPostItem.getP_favor_count() > 0) {
						startActivity(new Intent(MyFavoredActivity.this, AllFavorsActivity.class)
			...
			holder.favorBtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (!jsonPostItem.isLike()) {
						AsyncHttpClientTool.post(MyFavoredActivity.this, "post/like", params, responseHandler);
					} else {
						AsyncHttpClientTool.post(MyFavoredActivity.this, "post/unlike", params, responseHandler);
					}
				}
			});
			...
			holder.itemImageView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(MyFavoredActivity.this, ImageShowerActivity.class);
		...
		public void goBigPhoto(String[] urls, int postion) {
			Intent intent = new Intent(MyFavoredActivity.this, GalleryPictureActivity.class);
